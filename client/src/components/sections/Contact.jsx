            ...
            <div className='max-w-5xl mx-auto'>
                ...
                <div className='mt-12 text-center'>
                    ...
                    <div className='flex justify-center gap-3 flex-wrap'>
                        <a href='https://www.linkedin.com/in/rabin-humagain-417a35410' target='_blank' rel='noopener noreferrer' className='group flex items-center gap-2 h-11 rounded-xl bg-zinc-200 dark:bg-softdark border border-zinc-300 dark:border-borderColor hover:border-[#0077B5] hover:bg-[#0077B5] hover:text-white transition-all duration-300 text-zinc-600 dark:text-zinc-300 overflow-hidden' aria-label='LinkedIn'>
                            ...
                            <span className='max-w-0 group-hover:max-w-[180px] transition-all duration-300 overflow-hidden text-sm font-medium whitespace-nowrap pr-3'>rabin-humagain</span>
                        </a>
                        <a href='https://github.com/rabin0811' target='_blank' rel='noopener noreferrer' className='group flex items-center gap-2 h-11 rounded-xl bg-zinc-200 dark:bg-softdark border border-zinc-300 dark:border-borderColor hover:border-zinc-600 hover:bg-zinc-700 hover:text-white transition-all duration-300 text-zinc-600 dark:text-zinc-300 overflow-hidden' aria-label='GitHub'>
                            <span className='w-11 h-11 flex items-center justify-center shrink-0'>
                            ...
                            <span className='max-w-0 group-hover:max-w-[140px] transition-all duration-300 overflow-hidden text-sm font-medium whitespace-nowrap pr-3'>rabin0811</span>
                        </a>
                        <a href='https://facebook.com/rabin.humagai' target='_blank' rel='noopener noreferrer' className='group flex items-center gap-2 h-11 rounded-xl bg-zinc-200 dark:bg-softdark border border-zinc-300 dark:border-borderColor hover:border-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all duration-300 text-zinc-600 dark:text-zinc-300 overflow-hidden' aria-label='Facebook'>
                            <span className='w-11 h-11 flex items-center justify-center shrink-0'>
                                <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24' fill='currentColor'><path d='M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z'/></svg>
                            </span>
                            <span className='max-w-0 group-hover:max-w-[180px] transition-all duration-300 overflow-hidden text-sm font-medium whitespace-nowrap pr-3'>rabin.humagai</span>
                        </a>
                        <a href='https://instagram.com/__ra_bin__' target='_blank' rel='noopener noreferrer' className='group flex items-center gap-2 h-11 rounded-xl bg-zinc-200 dark:bg-softdark border border-zinc-300 dark:border-borderColor hover:border-[#E4405F] hover:bg-[#E4405F] hover:text-white transition-all duration-300 text-zinc-600 dark:text-zinc-300 overflow-hidden' aria-label='Instagram'>
                            <span className='w-11 h-11 flex items-center justify-center shrink-0'>
                            ...
                            <span className='max-w-0 group-hover:max-w-[160px] transition-all duration-300 overflow-hidden text-sm font-medium whitespace-nowrap pr-3'>__ra_bin__</span>
                        </a>
                        <a href='https://wa.me/9779762342058' target='_blank' rel='noopener noreferrer' className='group flex items-center gap-2 h-11 rounded-xl bg-zinc-200 dark:bg-softdark border border-zinc-300 dark:border-borderColor hover:border-[#25D366] hover:bg-[#25D366] hover:text-white transition-all duration-300 text-zinc-600 dark:text-zinc-300 overflow-hidden' aria-label='WhatsApp'>
                            <span className='w-11 h-11 flex items-center justify-center shrink-0'>
                            ...
                            <span className='max-w-0 group-hover:max-w-[200px] transition-all duration-300 overflow-hidden text-sm font-medium whitespace-nowrap pr-3'>+977 9762342058</span>
                        </a>
                    </div>
                </div>
            </div>
